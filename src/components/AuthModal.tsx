...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const [googleTeamInput, setGoogleTeamInput] = useState('');
  ...
  const handleGoogleConnect = async (customEmail?: string, customName?: string, customTeam?: string) => {
    setError(null);
    setSuccessMessage(null);
    ...
    if (!targetEmail || !targetEmail.includes('@')) {
      // Open modal to input their Gmail
    ...
    if (!cleanEmail.endsWith('@gmail.com') && !cleanEmail.includes('google')) {
      // Prompt note but still allow
    }

    setLoading(true);
    const trainerName = customName || googleNameInput || regName || cleanEmail.split('@')[0];
    const clubName = customTeam || googleTeamInput || regTeamName || `${trainerName} FC`;
    ...
    if (res.success) {
      ...
      setError(res.error || 'Não foi possível conectar com o Gmail. Tente novamente.');
    }
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/60 backdrop-blur-xs overflow-y-auto">
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200 my-auto">
        ...
        <div className="p-6">
          ...
          {/* Prompt to input Gmail if clicked "Conectar com Gmail" without email */}
          {showGooglePrompt && !currentUser && (
            <div className="mb-5 p-4 rounded-xl bg-blue-50/80 border border-blue-200 animate-in fade-in">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="text-xs font-bold text-blue-950">Conectar com sua Conta Gmail</h4>
              </div>
              <p className="text-[11px] text-blue-800 mb-3">
                Informe o seu endereço @gmail.com para vincular ou criar sua conta automaticamente na liga:
              </p>
              <div className="space-y-2">
                ...
                <div className="flex gap-2 justify-end pt-1">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1.5 text-xs font-bold bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors disabled:opacity-50"
                  >
              ...
              <div className="pt-2 border-t border-slate-100">
                ...
                <div className="flex flex-wrap gap-1.5">
                  <button
                    ...
                    className="px-2.5 py-1 text-[11px] bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-200 rounded-lg font-bold flex items-center gap-1 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 text-[11px] bg-blue-50 hover:bg-blue-100 text-blue-900 border border-blue-200 rounded-lg font-bold flex items-center gap-1 transition-colors"
                  >
